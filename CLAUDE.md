...
| 최신 검증 gameplay slice | N2-PACE-35 nav 이동 복구. v5 stuck gate 통과, duration gate 실패 |
| 최신 검증 운영 slice | N2-PACE-35 canonical v4/v5 5-run 기준선 정리 |
| 현재 운영 slice | N2-PACE-36 stage1 소모와 최종 2인 교착 분리 진단 |

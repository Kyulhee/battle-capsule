...
| 최신 검증 gameplay slice | N2-PACE-33 bot-vs-bot damage pacing 후보. 초 단위는 재측정 필요 |
| 최신 검증 운영 slice | N2-PACE-34 canonical clock/nav readiness 기반 정리 |
| 현재 운영 slice | N2-PACE-35 canonical v4/v5 5-run 기준선 재구축 |

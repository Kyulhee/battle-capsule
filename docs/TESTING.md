...
> 마지막 업데이트: 2026-06-18 (opening objective interrupt window 추가)
...
# opening idle-loot 7s/1m hard-bump interrupt safety, exact-threshold ammo need classification, and immediate-value loot priority.

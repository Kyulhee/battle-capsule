...
> 마지막 업데이트: 2026-06-18 (opening bump reveal guard 추가)
...
# verify_bot_opening_loot_rules.gd guards the idle-loot 2s grace, 5m close-interrupt cutoff, opening idle-reaction 3s/2m grace,
# opening close-range 7s/1m hard-bump reveal guard, opening idle-loot 3s near-actor start/interrupt safety,

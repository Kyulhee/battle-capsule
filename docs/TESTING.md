...
> 마지막 업데이트: 2026-06-17 (opening proximity guard 추가)
...
# verify_bot_opening_loot_rules.gd guards the idle-loot 2s grace, 5m close-interrupt cutoff, exact-threshold ammo need classification,

...
> 마지막 업데이트: 2026-06-17 (opening loot safety guard 추가)
...
# opening idle-loot 3s near-actor start/interrupt safety, exact-threshold ammo need classification, and immediate-value loot priority.

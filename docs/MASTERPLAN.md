...
> 마지막 업데이트: 2026-05-07 (v1.6.3 후퇴 응전 + 아이템 시야 + 보급 군집 완화, v1.7 로드맵 유지)
> 이 문서는 AI 에이전트 간 인수인계 및 장기 방향 공유를 위해 작성되었습니다.

## 현재 상태

**현재**: v1.6.3 — 다음: v1.7 (AI Doctrine Hierarchy Refactor)
...
- 중앙 군집/무피해 같은 AI 회귀는 Telemetry 기준으로 자동 감지되도록 보강한다.

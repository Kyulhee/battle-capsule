...
- 최신 gameplay slice: N2-AI-04 플레이어 표적 기억 5초와 squad runtime gate
...
| 전투/AI | bot doctrine, opening guard, player 위협/5초 기억, 순수 결정 정책, 실제 duel/squad smoke, bot damage, nav unstick | squad 격리 목표 유지는 통과, 자연 교전 최소 간격은 약 1m. 확장 후보는 이탈 152.4회 | Night 근거 효용 가중치, 완전한 flashlight/fear/battery 전술 | 국소 전투원 분산 |
...
| T2 오프닝 체감 | 첫 1분이 즉사/무접촉 양극단이 아니게 함 | duel/squad 표적 유지는 개선, 확장 자동은 첫 조우 7.1초 과밀 | 자동 duration과 수동 대인 압박이 함께 납득됨 | Arena 국소 분산 |

...
- 최신 E-062 자동 생존: 평균 753.5초(576.3-881.9), alive@30/60/120/260 중앙값 `52/39/26/19`, T50/T10 `33.2/322.8초`, scale PASS다. clean packaged 수동 결과는 아직 없다
...
|---|---|---|---|
| 매치/AI/맵 | 60봇 공통 표면, 실제 NavMesh·전투·전략 gate, continuity v2·exposure v1·survival-break episode v2 exact aggregate | E-062 자동 gate는 통과했지만 episode death 84·전체 DISENGAGE reengage 25.0%와 실제 체감은 미판정이다 | E-062 clean packaged 수동 3판 |
...
|---|---|---|---|
| 1A | M1 종료 | 자동 gate를 통과한 E-062 current tracked 후보가 clean packaged 실제 3판을 통과 | N2-PLAY-11 |
...
1. N2-PLAY-11은 E-060 reachability cap/scatter와 E-061 속도 증가를 재조정하지 않는다. E-062는 1-run·5-run 자동 gate를 통과했으므로 새 수치 변경 없이 clean packaged 수동 3판으로 확대하고, 체감 실패 시 해당 상태만 좁게 재진단한다.

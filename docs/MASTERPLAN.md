...
|---|---|---|---|---|
| 매치/preset | `night_br_m1_60` 일반·수동·자동 공통 표면, bot-only simulation participant | 무인자 Main runtime이 260m·60봇·loot 200 계약 통과 | 10-15분 canonical 분포, 99명 default 승격 | N2-PACE-44 5-run |
...
|---|---|---|---|---|
| T1 페이싱 안정화 | 안정된 10-15분 match 분포 확보 | 기준 표면과 전략 AI는 통합됐지만 최신 5-run 분포 없음 | `night_br_m1_60` 5-run 이상에서 평균 600-900초와 개별 run 허용 범위를 함께 만족 | N2-PACE-44 재측정 |

...
- 최신 map/world slice: N2-MAP-11 도로·숲 지면 구분과 Cabin Row 지역 묶음
...
| 맵/경로 | 260m 후보, POI 엄폐, 실제 nav bake, 45도 지도, POI 전략 목적지, 도로·숲 지면, Cabin Row 지역 묶음 | 87개 장애물·10개 지면 구역, Cabin Row 실제 캡처와 nav hotspot 통과 | 전 지역 고유 실루엣, 최종 맵 승격, 자연스러운 병목·압력 | N2-PLAY-06에서 Cabin Row 진입감 판정 |
...
| T4 맵/경로 체감 | pickup과 지형이 자연스러운 이동·병목 선택을 만듦 | Cabin Row에 첫 지역 문법 적용, 다른 POI는 여전히 whitebox | 주요 POI가 물리 동선과 AI 목표로 연결되고 수동 체감 통과 | N2-PLAY-06 뒤 채택 시 두 번째 지역 확장 |

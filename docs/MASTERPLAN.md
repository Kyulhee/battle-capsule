...
- 최신 gameplay slice: N2-PLAY-04 로컬 지도·AI 교전 개선 채택, 맵 전체 압력과 오디오 세부 반복
...
- 최신 asset slice: N2-ASSET-03 앉기 발걸음·권총 균형과 CC0 칼 Foley 후보, 발걸음 3종 수동 채택
...
| 맵/경로 | 260m whitebox, POI 엄폐, 실제 nav bake, 45도 지도, POI 전략 목적지 | 장거리 비전투 이동 후보와 60봇 3-run 198.9-273.7초 | 최종 맵 승격, 자연스러운 병목·압력 | `xlarge_60`에서 거점 간 이동·전투 과소모 판정 |
...
| 자산/audio | 실사 총성 4종·칼 Foley 후보, 채택된 발걸음 3종, 핵심 icon·bush GLB | catalog 누락 0, 권총/앉기 감쇠와 길이·캐시 계약 | 오디오 재청취, rock/tree/landmark 대량 승격 | N2-PLAY-05 자세·전투 오디오 판정 |
...
| T4 맵/경로 체감 | pickup과 지형이 자연스러운 이동·병목 선택을 만듦 | 로컬 지도 개선, 비전투 AI와 POI 장기 목적지를 처음 연결 | 주요 POI가 물리 동선과 AI 목표로 연결되고 수동 체감 통과 | N2-PLAY-05 뒤 지역 실루엣·밀도 감사 |
| T5 자산 승격 | gameplay를 돕는 자산만 런타임으로 승격 | 총성·칼 후보, 앉기 감쇠, 발걸음 채택 | 오디오 재청취 통과와 실제 피드백 문제 감소 | N2-PLAY-05 오디오 판정 |

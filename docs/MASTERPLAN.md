...
| T4 맵/경로 체감 | pickup과 지형이 자연스러운 이동·병목 선택을 만듦 | Cabin Row 3입구 compound에 목표·입구·외곽 AI 앵커와 POI 점유 분산 연결 | 주요 POI가 물리 동선과 AI 목표로 연결되고 수동 체감 통과 | N2-PLAY-07 뒤 채택 시 두 번째 지역 확장 |

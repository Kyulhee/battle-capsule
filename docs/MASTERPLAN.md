...
| 맵/경로 | 260m 후보, Cabin Row·West Ridge, 실제 landmark 지도, 표면 이동 경제와 road waypoint | 도로 100%·일반 92%·숲 84%, 기존 NavMesh 회귀 통과 | 최종 맵 승격, 도로 노출과 숲 엄폐의 수동 선택 판정 | N2-PLAY-09 |
...
| T4 맵/경로 체감 | pickup과 지형이 자연스러운 이동·병목 선택을 만듦 | Cabin Row·Watch Post 두 장소와 표면 속도·선점 후보 | 세 장소를 도로·숲·병목 중 다른 선택으로 이동하고 선점 조우를 설명 가능 | N2-MAP-16 South Creek |

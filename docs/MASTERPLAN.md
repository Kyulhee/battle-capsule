...
- 최신 gameplay slice: N2-AI-05 perception 국소 캐시와 전투원 분리 조향
...
| 전투/AI | bot doctrine, opening guard, player 위협/5초 기억, 순수 결정·이동 정책, duel/squad smoke, 국소 분산, bot damage, nav unstick | squad 유지율 100%, 5-run 1.5m 미만 접촉 0회. 확장 후보는 이탈 152.4회 | Night 근거 효용 가중치, 완전한 flashlight/fear/battery 전술 | Night 규모 성능·pathing 회귀 |
...
| T2 오프닝 체감 | 첫 1분이 즉사/무접촉 양극단이 아니게 함 | duel/squad 표적 유지·국소 분산 개선, 확장 자동은 첫 조우 7.1초 과밀 | 자동 duration과 수동 대인 압박이 함께 납득됨 | Night 규모 회귀 뒤 수동 first-minute |

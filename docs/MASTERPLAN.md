...
| 지표 | 목표 창 | 현재 | 판단 |
|---|---|---|---|
| first upgrade | 120-300초 | 293.9초 | 유지 |
| stage2 | 240-420초 | 285.8초 | 유지 |
| stage3 | 540-720초 | 655.7초 | 유지 |
| match duration | 600-900초 | 554.3초 | 먼저 여유 확보 |

첫 1분은 즉사나 랜덤 충돌보다 위험을 읽고 선택하는 느낌이어야 한다. opening contact를 더 늦추기 전에 match duration 600초 기준을 안정화하고, 이후 수동 플레이에서 오프닝과 route/cover 판독을 함께 확인한다.

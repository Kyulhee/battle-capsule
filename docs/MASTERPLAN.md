...
| 전투/AI | bot doctrine, opening guard, player-target 위협 분리, 순수 결정 정책, 실제 Arena duel smoke, bot damage, nav unstick | player 근접 감지는 수동/런타임 개선 확인. 확장 후보는 이탈 152.4회 | Night 근거 효용 가중치, 완전한 flashlight/fear/battery 전술 | `squad_4` 목표 유지·분산 계측 |
...
| T2 오프닝 체감 | 첫 1분이 즉사/무접촉 양극단이 아니게 함 | 근접 duel은 수동/자동 개선, 확장 자동은 첫 조우 7.1초 과밀 | 자동 duration과 수동 대인 압박이 함께 납득됨 | Arena `squad_4` 계측 |

...
> 최종 업데이트: 2026-07-21. 남은 작업은 마일스톤 -> 트랙 -> 종료 조건 -> 다음 slice 순서로 관리한다.
...
- 최신 gameplay slice: N2-PLAY-05 긴장·조우·앉기 발걸음 채택, 칼과 거점·지역 밀도 반복
- 최신 AI slice: N2-AI-08 근거리 loot 종료 뒤 정지하던 IDLE에 저빈도·장기 POI 목적지 연결
- 최신 map/world slice: N2-MAP-13 내부 POI 반경과 전체 지도 landmark 표현 분리
- 최신 UI slice: N2-UI-01 플레이어 중심 120m/280px 미니맵과 Main 단일 소유권
- 최신 asset slice: N2-ASSET-04 CC0 칼 휘두름 3종·살점 피격음 분리, 앉기 발걸음 수동 채택
...
| 전투/AI | bot doctrine, player 위협/5초 기억, player-target 국소 분산, 검색 캐시, nav unstick, IDLE POI 전략 이동 | 교전 체감 채택, squad 유지율 100%, 60봇 p95 12.9ms, 99봇 AI 146.2µs | 전략 이동 수동 승격, flashlight/fear/battery 전술 | N2-PLAY-05 맵 압력·과소모 판정 |
...
| 맵/경로 | 260m 후보, 실제 nav bake, POI 내부 반경, 지면 구역, 명시적 엄폐, Cabin Row 3입구 compound | 지도 POI 원 제거, 실제 landmark identity·실루엣, 세 입구 NavMesh 경로 통과 | 두 번째 지역 문법, 최종 맵 승격, 자연스러운 병목·압력 | N2-MAP-14 West Ridge Watch Post |
...
| 자산/audio | 실사 총성 4종, 칼 휘두름 3종·피격음, 채택된 발걸음 3종, tree·Cabin Row GLB | catalog 누락 0, 오디오 분리·길이·캐시와 프롭 개수 계약 | 칼 재청취, 나머지 지역 자산 승격 | N2-PLAY-06 칼·거점 판정 |
...
| T4 맵/경로 체감 | pickup과 지형이 자연스러운 이동·병목 선택을 만듦 | Cabin Row 물리·AI 문법과 POI 원 없는 landmark 지도 계약 완료 | landmark 무더기·지면·엄폐·AI 목적만으로 두 지역을 구분하고 수동 체감 통과 | N2-MAP-14 West Ridge Watch Post |

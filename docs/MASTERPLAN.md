...
- 최신 gameplay slice: N2-AI-02 위협·표적·위치 효용 순수 정책 분리
...
| 전투/AI | bot doctrine, opening guard, player-target 위협 분리, 순수 위협·표적·위치 효용 정책, bot damage, nav unstick | player 근접 감지는 수동 개선 확인. 확장 후보는 이탈 152.4회로 bot-only 전략 실패 노출 | Night 근거 효용 가중치, 완전한 flashlight/fear/battery 전술 | Arena에서 목표 유지·엄폐 분산 행동 계약 |
...
| T2 오프닝 체감 | 첫 1분이 즉사/무접촉 양극단이 아니게 함 | 근접 감지는 수동 개선, 확장 자동은 첫 조우 7.1초 과밀 | 자동 duration과 수동 대인 압박이 함께 납득됨 | Arena 목표 유지·위치 효용 |

...
| 맵/경로 | 기존 Night + 260m 확장 whitebox, open 피해 계측, high rock ramp 제거, 96m Arena traffic, 45도 정렬 지도 | open 4봇 stuck 0, axis wall 2. 제품 wall은 국소 16회라 미승격 | 최종 맵 승격, 자연스러운 병목 | Box corner clearance를 Arena에서 0으로 낮춤 |
...
| T4 맵/경로 체감 | pickup과 지형이 자연스러운 이동·병목 선택을 만듦 | log·회전 wall 기각, axis wall도 Arena 2회/제품 16회 정체. 다중 gate도 필요조건일 뿐 충분조건은 아님 | 주요 POI가 물리 동선과 AI 목표로 연결되고 stuck gate 통과 | N2-NAV-02 wall traffic stuck 0 뒤 한 개만 맵 재검증 |

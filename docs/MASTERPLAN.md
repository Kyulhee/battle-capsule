...
> 마지막 업데이트: 2026-05-08 (v1.7.2 아키타입 지표/헬 총성 인식 보정 릴리즈)
> 이 문서는 AI 에이전트 간 인수인계 및 장기 방향 공유를 위해 작성되었습니다.

## 현재 상태

**현재**: v1.7.2 — 다음: v1.7.3 (미니맵/맵 일치성 개선)
...
### v1.7.3 — Minimap Map Consistency `S`
...
**현재 미해결 이슈**
- 미니맵이 실제 맵의 상단 시점 최종 형태와 불일치하는 문제가 있다. v1.7.3에서 `MapSpec`/`WorldBuilder`/`Minimap` 연결성을 점검한다.

...
- 최신 gameplay slice: N2-AI-06 플레이어 대상 전투로 좁힌 국소 캐시와 분리 조향
...
| 전투/AI | bot doctrine, opening guard, player 위협/5초 기억, 순수 결정·이동 정책, duel/squad smoke, player-target 국소 분산, bot damage, nav unstick | squad 유지율 100%, 강제 근접 0.2초 분리. 60/99봇 정체·이탈 회귀 통과 | Night 근거 효용 가중치, 완전한 flashlight/fear/battery 전술 | `xlarge_60` 수동 대인 압박 |
...
| T2 오프닝 체감 | 첫 1분이 즉사/무접촉 양극단이 아니게 함 | duel/squad 표적 유지·국소 분산과 Night 규모 회귀 통과, 확장 자동은 첫 조우 7.1초 과밀 | 자동 duration과 수동 대인 압박이 함께 납득됨 | `xlarge_60` 수동 first-minute |

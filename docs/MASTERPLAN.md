...
| T2 오프닝 체감 | 첫 1분이 즉사/무접촉 양극단이 아니게 함 | AI 교전은 채택됐지만 맵 압력 부재. POI 전략 이동 3-run 평균 231.1초 | 교전 품질을 보존하며 이동 압력과 과소모가 함께 납득됨 | N2-PLAY-05 |
...
| T4 맵/경로 체감 | pickup과 지형이 자연스러운 이동·병목 선택을 만듦 | Cabin Row에 3입구 compound 문법 적용, 다른 POI는 여전히 whitebox | 주요 POI가 물리 동선과 AI 목표로 연결되고 수동 체감 통과 | N2-PLAY-06 뒤 채택 시 두 번째 지역 확장 |

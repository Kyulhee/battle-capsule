...
다음 행동: route 표현과 지도 정렬, 플레이어 근접 위협, Arena 국소 분산은 완료했다. 자연 `squad_4` 5-run은 1.5m 미만 접촉 0%, 강제 1.1m 쌍은 0.15-0.25초 안에 분리됐다. Night 규모 회귀 확인 뒤 `xlarge_60`에서 교전 간격과 첫 1분 압박을 다시 본다.

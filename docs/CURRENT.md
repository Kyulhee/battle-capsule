...
> 최종 업데이트: 2026-09-12. 작업 시작 전 이 문서를 먼저 읽는다.
...
| 바로 다음 단위 | E-075: 구역 전환에 맞춘 동일 단계 재고 관측과 빈 탄약 RECOVER/IDLE 탐색 진단. E-074의260초는4/5쌍이 stage wave 전/후를 달리 읽어 재고 비교 불가였다. 초기 ID뿐 아니라 stage/수축 상태를 검증하고 시간 제한만으로 보급 개선을 가정하지 않는다. E-071은 opt-in 유지, 기본 적용·드랍/시야 변경·새 EXE 없음 |
| 최신 검증 개발 단위 | E-074 `3220d11`: 진단 지연 로딩·ID exact 회귀·전체 unit_smoke/tooling PASS. 부모 `9f23dde` 대조/후보 비계측5+5, 초기5쌍 exact·합계332,847 AI표본, 평균696.0/750.5초·max22,638/26,514us로 양군 gate PASS. 120초 빈 탄약24.2/25.0%, alive120/260 중앙26/17→28/17로 보급/생존 승격 아님. `builds/verification/E074_probe_identity/RESULTS.md`에 phase 제한과 원시10판 보존. E-073 오염8판·E-0711.19초 실패도 보존, 수동 hash불변 |

...
| 항목 | 값 |
|---|---|
| 현재 단위 | E-065 소리 반응 수정 완료. clean 소스 `04bed12`의 Windows EXE 부팅과 Windows/macOS PCK·메뉴 식별 검증 PASS. 실행 파일은 `builds/playtest/E-065_04bed12/BattleCapsule_E065_04bed12.exe`, 메뉴는 `v2.1.0-demo-dev \| E-065`. 수동 반응 재판정 대기 |

...
| 항목 | 값 |
|---|---|
| 현재 단위 | N2-AI-03 Arena 기반 목표·위치 효용 행동 계약 |
| 최신 검증 개발 단위 | N2-AI-02 `BotDecisionPolicy` 위협·표적·위치 효용 분리 |
...
| P1 | AI 교전 결정 재설계 | 기반 완료: 순수 정책과 회귀 테스트 분리. 다음: Arena에서 목표 유지·엄폐 분산 행동 계약 |

...
| 항목 | 값 |
|---|---|
| 현재 단위 | N2-MAP-10 올바른 260m 월드의 빈 공간·픽업·물리 병목 감사 |
| 최신 검증 개발 단위 | N2-PERF-02 Minimap 정적 지도 캐시와 60봇 Forward+ 성능 복구 |
...
| P4 | 맵/경로 체감 점검 | 올바른 월드와 성능 기준선 확정. 빈 공간·픽업·이동 흐름 감사 뒤 비기본 후보 한 개만 검증 |

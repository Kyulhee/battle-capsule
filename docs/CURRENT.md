...
| 항목 | 값 |
|---|---|
| 현재 단위 | N2-AI-04 `squad_4` 목표 유지·분산 행동 계측 |
| 최신 검증 개발 단위 | N2-TOOLS-02 실제 Main 기반 Arena duel 런타임 smoke |
...
| P1 | AI 교전 결정 재설계 | 기반/duel 완료. 다음: `squad_4`에서 목표 유지·분산을 먼저 계측하고 효용 변경 |

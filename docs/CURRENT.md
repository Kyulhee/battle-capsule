...
| 항목 | 값 |
|---|---|
| 현재 단위 | N2-PLAY-06 Cabin Row 3방향 진입·엄폐 전환과 칼 분리음 수동 판정 |
| 최신 검증 개발 단위 | N2-MAP-12 명시적 엄폐 계약과 3방향 Cabin Row compound |
...
| P4 | 맵/경로 체감 점검 | 첫 compound 완료: 3동 건물, 남·서·동 입구, 탄도 엄폐와 수목 시야 차폐. N2-PLAY-06 수동 판정 |
...
| 맵 전체 압력 부족 | POI 전략 이동만으로는 거점감이 없고 산개 프롭처럼 보였음 | Cabin Row를 남·서·동 3입구와 중앙 보상 마당으로 재구성. 같은 문법을 복제하기 전 N2-PLAY-06 수동 판정 |
...
| 60봇 프레임 버벅임 | N2-MAP-12 15초 2회 p95 12.71-12.86ms, 33ms 초과 0.075%, 평균 177 FPS. 99봇 스트레스 p95 54.5ms | 60인 체감 재확인, 99인은 기본 승격 금지 유지 |

...
| 항목 | 값 |
|---|---|
| 현재 단위 | N2-AI-01 대인 교전 지속·이탈과 맵 체감 규모 audit |
| 최신 검증 개발 단위 | N2-MAP-04 route 표현 철회와 전체맵 45도 정렬 |
...
| 구조적 교전 밀도 | 정지 시 접촉 부족, 맵은 예상보다 좁고 평지가 비어 보임 | 좌표 크기만 늘리지 말고 pickup·시야 차단·병목·이동 시간의 밀도 지도를 먼저 작성 |

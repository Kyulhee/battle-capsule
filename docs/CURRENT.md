...
| 바로 다음 단위 | E-066에서 낡은/표준 무기의 습득 전후 구분만 짧게 확인한다. 다음 개발은 `N2-LOOT-FLOW-01`: 유효 탄약 부족·거점 재고·120/260초 이동/생존을 확인하고 두 거점의 유한 보급 재배치를 단일 후보화한다. 후방 급회전·폭격·건물은 이번에 섞지 않음 |

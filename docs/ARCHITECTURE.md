...
| `src/core/MapDefinition.gd` | v2.0 map/match-scale compatibility wrapper over existing MapSpec JSON | Main reads selected scale preset data; WorldBuilder/Minimap/FullMapOverlay still consume the wrapped MapSpec |

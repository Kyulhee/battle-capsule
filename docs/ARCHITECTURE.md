...
| 맵 구조 변경 | `MapDefinition.gd` + `MapSpec.gd` + `WorldBuilder.gd` | v2.0 compatibility layer validates map/match scale first; runtime call sites migrate from MapSpec in later slices |

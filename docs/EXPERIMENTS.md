...
| ID | 질문 | 최신 증거 | 판단 |
|---|---|---|---|
| E-068 | 두 POI의 기존 소모품 한 슬롯을 첫 총과 호환되는 탄약으로 구성하면 유효 재고가 개선되는가? | `builds/verification/E068_initial` 5쌍: 총/위치/RNG/비대상 불변·1-2슬롯 교체. `E068_control`/`E068_candidate` 각 1-run 725.0/854.5초, alive@120/260 `26/18`·`28/17`, T10 293.9/299.1초, 구조 PASS | 도구에서만 활성, 기본/EXE 미적용. 초기 호환 계약만 확인했으며 생존 개선 근거 부족. 후보의 Survey 초기 탄약은 120초에 잔존·260초 소진; 완전 탄약 소진 봇은 대조 `8/8`, 후보 `10/6`. 대조/후보 각 별도 5-run 전 승격 금지 |

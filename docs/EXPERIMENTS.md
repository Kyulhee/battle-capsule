...
| E-008 | bot끼리의 damage만 낮추면 timing band를 유지하며 match 여유가 생기는가? | v5의 bot-only 0.55 동작은 검증. N2-PACE-33 초 단위는 initialization 오염으로 무효 | 비기본 가설 유지, canonical 5-run 재실행 |

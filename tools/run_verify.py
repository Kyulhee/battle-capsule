...
def profile_steps(
    ...
    if profile == "tooling":
        return [*docs_only, py_compile(report_scripts),
                ...
                Step("loot search analysis", [sys.executable, rel("tools/verify_loot_search_analysis.py")])]
    ...
    if profile == "unit_smoke":
        return [
            *docs_only,
            ...
            godot_script_args(
                godot,
                "verify_player_survival_runtime.gd",
                [
                    "map_spec_path=res://data/mapSpec_ai_test_arena.json",
                    "scale_preset=duel_1",
                    "simulation_seed=41000",
            ...
            godot_script_args(
                godot,
                "verify_night_south_creek_nav.gd",
                [
                    "map_spec_path=res://data/mapSpec_night_forest_expanded_candidate.json",
                    "scale_preset=nav_hotspot_1",
                    "simulation_seed=41000",
            ...
            godot_script_args(
                godot,
                "verify_night_micro_compound_nav.gd",
                [
                    "map_spec_path=res://data/mapSpec_night_forest_expanded_candidate.json",
                    "scale_preset=nav_hotspot_1",
                    "simulation_seed=41000",
